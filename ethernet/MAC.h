...
extern FCP_Packet_t packet;
extern FCP_Packet_t packet1;	//for debugging
extern FCP_Packet_t packet2;	//for debugging
extern FCP_Packet_t packet3;	//for debugging
extern FCP_Packet_t inPacket;
#define MAXBUF 200
extern unsigned char RcvMessage[MAXBUF];
...
////
// Returns a (read-only) reference to the boards MAC address
////
...
// The original version from the driver. No blocking.
